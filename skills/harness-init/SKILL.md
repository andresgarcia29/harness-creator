...
| `scripts/context-distill.sh` | scripts/ | siempre (patrón MinionS, ADR-0011: el reader destila contexto; opt-in via context_distill en answers) |
| `docs/adr/ADR-0011-minions-context-distill.md` | docs/adr/ADR-0011-*.md | siempre (decisión PROPUESTA a ratificar) |
