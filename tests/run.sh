...
failed=0
for t in test_emit.sh test_track_read.sh test_docs.sh test_build_slot.sh test_gowork_shims.sh test_ship_gates.sh test_stamp_models.sh test_graph_refresh.sh test_discover.sh test_doctor.sh; do
